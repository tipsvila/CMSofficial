    ...
    <ErrorBoundary>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          ...
          <StatCard title="Inquiries" value={stats.totalInquiries || 0} comparison={`${stats.wonInquiries || 0} won`} icon={<ClipboardCheck size={22} />} color="info" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <ChartCard title="Top Agencies" subtitle="By contract value" type="bar" data={agencyChartData} />
        </div>

        {/* Row 4: Compliance + Agencies Detail */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
